...
## [A Note on GraphQL](https://linera-dev.respeer.ai/#/zh_CN/core_concepts/node_service?id=a-note-on-graphql)
...
## [GraphQL System API](https://linera-dev.respeer.ai/#/zh_CN/core_concepts/node_service?id=graphql-system-api)
...
## [GraphQL Application API](https://linera-dev.respeer.ai/#/zh_CN/core_concepts/node_service?id=graphql-application-api)
