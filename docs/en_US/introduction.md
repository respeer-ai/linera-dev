...
1. The first section gives a [high-level overview](../en_US/protocol/overview.md) of the
   protocol.

2. The second section is intended for
   [developers](../en_US/developers/getting_started.md) building applications using the
   Linera Rust SDK.

3. The third section is intended for [operators](../en_US/operators/devnets.md) who wish
...
> [this page](../en_US/developers/getting_started/hello_linera.md#using-the-testnet) to
