...
will see in the [next section](../../../en_US/developers/core_concepts/node_service.md) how a Linera wallet can run a
...
[previous section](../../../en_US/developers/getting_started/hello_linera.md))
