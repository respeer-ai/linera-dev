...
Now that the
[validator configuration](../../../en_US/operators/testnets/manual-installation.md#creating-your-validator-configuration)
has been created and the
[genesis configuration](../../../zh_CN/operators/testnets/manual-installation.md#genesis-configuration) is
