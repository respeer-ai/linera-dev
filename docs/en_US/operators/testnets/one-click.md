...
After downloading the linera-protocol repository and checking out the testnet branch testnet_babbage, you can run scripts/deploy-validator.sh <hostname> to deploy a Linera validator.
