...
- [**1.** 开发者手册](zh_CN/developers.md)
  ...
  - [**1.2.** Linera协议](zh_CN/developers/core_concepts.md)
      ...
      - [**1.2.5.** 应用程序](zh_CN/developers/core_concepts/applications.md)
  - [**1.3.** 编写Linera应用](zh_CN/developers/sdk.md)
   ...
   - [**1.4.** 进阶主题](zh_CN/developers/advanced_topics.md)
      - [**1.4.1.** 视图(Views)](zh_CN/developers/advanced_topics/views.md)
      - [**1.4.2.** 持久化存储](zh_CN/developers/advanced_topics/persistent_storage.md)
      - [**1.4.3.** 合约执行完毕](zh_CN/developers/advanced_topics/contract_finalize.md)
      - [**1.4.4.** 验证器](zh_CN/developers/advanced_topics/validators.md)
      - [**1.4.5.** 创建新区块](zh_CN/developers/advanced_topics/block_creation.md)
      - [**1.4.6.** 应用程序中的资产](zh_CN/developers/advanced_topics/assets.md)
   - [**1.5.** 实验性主题](zh_CN/developers/experimental.md)
      - [**1.5.1.** Linera 上的机器学习](zh_CN/developers/experimental/ml.md)
-  [**2.** 节点运营商手册](zh_CN/operators.md)
   - [**2.1.** 开发网络](zh_CN/operators/devnets.md)
      - [**2.1.1.** Docker Compose](zh_CN/operators/devnets/compose.md)
      - [**2.1.2.** kind](zh_CN/operators/devnets/kind.md)
   - [**2.2.** 测试网](zh_CN/operators/testnets.md)
