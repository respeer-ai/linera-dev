...
## [How does it work?](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=how-does-it-work)
...
## [How does Linera compare to existing multi-chain infrastructure?](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=how-does-linera-compare-to-existing-multi-chain-infrastructure)
...
## [Why build on top of Linera?](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=why-build-on-top-of-linera)
...
## [What is the current state of the development of Linera?](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=what-is-the-current-state-of-the-development-of-linera)
...
### [Core Protocol](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=core-protocol)
...
### [Wasm VM integration](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=wasm-vm-integration)
...
### [Storage](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=storage)
...
### [Validator Infrastructure](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=validator-infrastructure)
...
### [Web3 SDK](https://linera-dev.respeer.ai/#/v1/en_US/core_concepts/overview?id=web3-sdk)
