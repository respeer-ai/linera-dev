...
## [Unit tests](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=unit-tests)
...
Alternatively, one may set up the environment and run `cargo test` directly as described [below](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=manually-configuring-the-environment).

### [Example](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=example)
...
### [Mocking System APIs](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=mocking-system-apis)
...
### [Running Unit Tests with `cargo test`](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=running-unit-tests-with-cargo-test)
...
## [Integration Tests](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=integration-tests)
...
### [Example](https://linera-dev.respeer.ai/#/v1/en_US/sdk/testing?id=example-1)
